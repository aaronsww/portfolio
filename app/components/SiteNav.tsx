...
export default function SiteNav() {
  return (
    <nav className="fixed inset-x-0 top-0 z-40 flex items-center justify-between border-b border-white/5 bg-[var(--background)]/70 px-6 py-5 backdrop-blur-md md:px-12">
      <Link
        href="/"
